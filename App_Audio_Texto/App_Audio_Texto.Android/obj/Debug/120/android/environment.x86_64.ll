...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"707c1b89-6d4f-460d-9bd6-d5730cc272b1\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [32 x i8] c"com.companyname.app_audio_texto\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [54 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.lu.so\00", align 16
@__DSOCacheEntry_name.2 = internal constant [18 x i8] c"libmono-native.so\00", align 16
@__DSOCacheEntry_name.3 = internal constant [46 x i8] c"libMicrosoft.CognitiveServices.Speech.core.so\00", align 16
...
@__DSOCacheEntry_name.7 = internal constant [61 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.audio.sys.so\00", align 16
@__DSOCacheEntry_name.8 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
@__DSOCacheEntry_name.9 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 16
@__DSOCacheEntry_name.10 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 16
@__DSOCacheEntry_name.11 = internal constant [55 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.so\00", align 16
...
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([55 x i8], [55 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 20
	%struct.DSOCacheEntry {
