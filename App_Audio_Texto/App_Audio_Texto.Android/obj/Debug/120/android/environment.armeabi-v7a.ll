...
@__DSOCacheEntry_name.1 = internal constant [61 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.audio.sys.so\00", align 1
...
@__DSOCacheEntry_name.4 = internal constant [55 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.so\00", align 1
...
@__DSOCacheEntry_name.7 = internal constant [46 x i8] c"libMicrosoft.CognitiveServices.Speech.core.so\00", align 1
...
@__DSOCacheEntry_name.10 = internal constant [54 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.lu.so\00", align 1
...
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([55 x i8], [55 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 4
	%struct.DSOCacheEntry {
